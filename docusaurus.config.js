    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/TotallyNotAGear/corps-and-contracts',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'GitHub',
                href: 'https://github.com/corps-and-contracts/wiki',
              },
            ],
          },
        ],
        copyright: `Copyright © ${new Date().getFullYear()} Corps and Contracts community`,
      },
      prism: {
